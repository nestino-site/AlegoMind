...
import { IconSearch, IconCalendar, IconMessage, IconUsers, IconShield } from "@/components/ui/Icons";

const NAV = [
  { href: "/acasa",       label: "Acasa",       Icon: IconShield   },
  { href: "/explorez",    label: "Explorez",    Icon: IconSearch   },
  { href: "/conversatii", label: "Conversatii", Icon: IconMessage  },
  { href: "/sesiuni",     label: "Sedinte",     Icon: IconCalendar },
    ...
    return (
      <div className="min-h-dvh bg-bg flex">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="hidden lg:flex items-center justify-between px-8 h-14 border-b border-border bg-white sticky top-0 z-30">
            <div className="relative w-72">
              ...
              <input type="search" placeholder="Cauta furnizori, subiecte..." className="w-full rounded-xl border border-border bg-bg py-2 pl-9 pr-3 text-xs text-text-primary placeholder:text-text-muted focus:outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 transition-all" />
            </div>
        ...
        <ConfirmDialog
          ...
          message="Vei fi deconectat din cont. Poti reveni oricand."
